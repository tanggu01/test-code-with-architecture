...
//    public Optional<UserEntity> findById(long id) { // use `find` for return optional
...
//    }
    ...
    public UserEntity getById(long id) { // do not include `orElseThrow` for `get`, use `find` instead
        return userRepository.findByIdAndStatus(id, UserStatus.ACTIVE)
